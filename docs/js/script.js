...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2023-06-11');
});
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_2__["postData"])('http://localhost:3000/requests', JSON.stringify(object)).then(data => {
        console.log(data);
...
function menu() {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_0__["getResource"])('http://my-json-server.typicode.com/darbimar/Health-Food/menu').then(data => {
    data.forEach(({
      img,
      altimg,
      title,
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  const modalOpenButton = document.querySelector(triggerSelector),
        modal = document.querySelector(modalSelector);
  modalOpenButton.addEventListener('click', () => openModal(modalSelector, modalTimerId));
